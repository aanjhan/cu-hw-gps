...
%Copyright 2009, Cornell University, Electrical and Computer Engineering, Ithaca, NY 14850
 ...
 FC = (88.54/63)*(1.e+06);            %incoming center frequency
 W_FC = 2*pi*FC;
 TP = 175e-9;                         %sample spacing
 T_RES = 12.5e-9;                     %time resolution for fine code acquisition 
 ...
 FSAMP_MSEC = 40e3/7;                 %number of samples in 1 millisecond
 AMP = sqrt(5);                       %this is the optimal signal amplitude to demodulate the data at, statistically
 SNR_FLOOR = 97142;                   %the statistical SNR floor
 ...
 HNUM=5.8651e-7;
 CNO_MIN = 35;                        %minimum code lock value in DB
