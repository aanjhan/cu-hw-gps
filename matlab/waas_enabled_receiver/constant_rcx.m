...
%Copyright 2009, Cornell University, Electrical and Computer Engineering, Ithaca, NY 14850
 ...
 FC = (88.54/63)*10^6;            %incoming center frequency
 W_FC = 2*pi*FC;
 %FS = 16.8e6;
 FS = 5.714e6;
 TP = 175e-9;  %1/FS;                         %sample spacing
 T_RES = 12.5e-9; %TP/14;                     %time resolution for fine code acquisition 
 ...
 FSAMP_MSEC = 40000/7; %1e-3*FS;                 %number of samples in 1 millisecond
 AMP = sqrt(5);                       %this is the optimal signal amplitude to demodulate the data at, statistically
 SNR_FLOOR = 97142;  %80000;                   %the statistical SNR floor
